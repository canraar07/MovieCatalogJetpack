...
class DataDumy {
    fun generateDataDumyListMovie(): ArrayList<DataItems> {
        val listMovie = ArrayList<DataItems>()
        listMovie.add(
            DataItems(
                "Joker",
    ...
    fun generateDataDumyListTV(): ArrayList<DataItems> {
        val listMovie = ArrayList<DataItems>()
        listMovie.add(
            DataItems(
                "Arrow",
    ...
    fun generetDumyDetailMovie() : ArrayList<ResponseDetailModel> {
        val detailMovie = ArrayList<ResponseDetailModel>()
        detailMovie.add(
            ResponseDetailModel(
            "Joker",
            "During the 1980s, a failed stand-up comedian is driven insane and turns to a life of crime and chaos in Gotham City while becoming an infamous psychopathic crime figure.",
